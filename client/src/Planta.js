...
export const Planta = (props) => {
  ...
  const [timeRiego, settimeRiego] = useState(undefined);
  ...
  useEffect(() => {
    (async () => {
      ...
      let ListFilteredEmpty = [];
      let ListEqualsDays = [];

      listDataSplit.forEach((element) => {
      ...
      let ListFilteredEmptyOrdened = ListFilteredEmpty.sort((a, b) =>
            ...
            dataHelp.forEach((element) => {
              if (
                ...
                element.days.forEach((element) => {
                  if (element.name == getDayLetterWeek(ListEqualsDays[i].day)) {
                    exist = true;
                  }
                });
  ...
  function getDayLetterWeek(dayTmp) {
    let letter = "";
    if (dayTmp === "Lunes") {
      letter = "L";
    }
  ...
  function saveTimeSelect(hour, minutes) {
          ...
          <div className="cardPlantaf">
            <div className="cardPlanta" onClick={changeStateEsp}>
              <div className="cardPlantac">
                ...
                {clock ? (
                  <>
                    <div className="clockPlanta">{temperature} °C</div>
                    <div className="clockPlanta">{clock}</div>
                  </>
                ) : (
                  <>
