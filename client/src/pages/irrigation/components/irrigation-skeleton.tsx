...
export const IrrigationSkeleton: React.FC = () => {
  return (
    <div className="pageIrrigation">
      ...
      <Grid container spacing={4} sx={{ width: '100%', maxWidth: '1200px' }}>
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <Paper className="cardIrrigation" sx={{ p: 3, height: '100%', borderRadius: '15px' }}>
            {/* Title */}
        ...
        <Grid size={{ xs: 12 }}>
          <Paper className="cardIrrigation" sx={{ p: 3, minHeight: '300px', borderRadius: '15px' }}>
            {/* Title */}
