...
export const PumpsControls: React.FC<PumpsControlsProps> = ({ onPumpCommand, bottles, onUpdatePump }) => {
  ...
  return (
    <Box sx={{ display: "flex", gap: 4, mt: 2, flexWrap: { xs: "wrap", lg: "nowrap" } }}>
      {/* Manual Control Card - Left Side */}
      <Paper
      ...
      {/* Pump Configuration Cards - Right Side */}
      <Box sx={{ flex: 1 }}>
        <PumpConfigCards bottles={bottles} onUpdatePump={onUpdatePump} />
      </Box>
    </Box>
  );
};
